...
<link rel="stylesheet" href="css/tema.css">
    ...
    <div style="width: 50%; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <h3 style="color: #007bff;">Editar Instructor</h3>
        <form action="../../modelos/instructor_edit.php" method="post" style="text-align: left;">
        <input type="hidden" id="id" name="id" value="<?php echo $row['id'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%;">
            ...
            <p>
                ...
                <input type="text" id="año" name="año" value="<?php echo $row['año'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%;">
            </p>
            

            <p>
                <label for="nombre" style="color: #000000;">Nombre del Instructor</label><br>
                <input type="text" id="nom_instructor" name="nom_instructor" value="<?php echo $row['nom_instructor'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%;">
            </p>
            <center>
                <!--
                <p>
            ...
            <p><p><br><br>
                ...
                <button type="button" class="salir" style="display: inline-block; width: 120px; padding: 10px 0; background-color: #555555; color: white;
                    font-size: 13px; font-family: 'Times New Roman', serif; text-decoration: none; border-radius: 1px; text-align: center;" name="exit" id="exit" onclick="window.location.href='../ADMIN/INSTRUCTORES.php'">                                  <i class="fa fa-sign-out"></i> Volver
                </button><br><br><br>
    </form>        
    <!-- Pie de página -->
