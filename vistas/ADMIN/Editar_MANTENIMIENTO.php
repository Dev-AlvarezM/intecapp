...
<body style="background-color: #f0f0f0; color: #333; font-family: Arial, sans-serif; text-align: center;">
    <div style="width: 50%; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <h3 style="color: #007bff;">Editar Encargado de Mantenimiento</h3>
        <form action="../../modelos/mantenimiento_edit.php" method="post" style="text-align: left;">
        <input type="hidden" id="id" name="id" value="<?php echo $row['id'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%;">
            ...
            <center>
                ...
                <p>
                    ...
                    <input type="date" id="f_reporte" name="f_reporte" value="<?php echo $row['f_reporte'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%;">
                </p>
                <p>
                    <label for="f_realizado" style="color: #000000;">Fecha de Finalización</label><br>
                    <input type="date" id="f_realizado" name="f_realizado" value="<?php echo $row['f_realizado'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%;">
                </p>
                <p style="text-align: center;">
                     <label for="descripcion" >Descripción</label><br>
                     <input type="text" id="descripcion" name="descripcion" value="<?php echo $row['descripcion'];?>" required style="border: 1px solid #207ffc; padding: 4px; width: 30%; margin: 0 auto;">
                </p>
                <p style="text-align: center;">
